...
<body>
    <div class="container">
        <h2 class="text-center justify-content-center">Kalkulator KPR</h2>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                ...
                <form method="post" onsubmit="return process()">
                    <div class="form-group">
                        ...
                        <input type="number" name="harga_rumah" min="120000000" id="harga_rumah" class="form-control input-sm rupiah" required="required" autofocus placeholder="Contoh : 300000000" value="" oninvalid="this.setCustomValidity('Harga rumah kurang dari 120000000')" oninput="setCustomValidity('')" />
                    </div>
                    <div class="form-group">
                        <label for="uang_muka">Uang Muka (minimal 20% dari harga rumah, dalam Rp)</label>
                        <input type="number" name="uang_muka" min="1" id="uang_muka" class="form-control input-sm" required="required" placeholder="Contoh : 60000000" onkeyup="uangMuka()" />
                    </div>
                    <div class="form-group">
                        <label for="margin">Bunga (dalam persen disetarakan p.a, asumsi kisaran 7.00 - 9.50)</label>
                        <input type="number" name="margin" min="5" max="20" id="margin" class="form-control input-sm" required="required" step="any" placeholder="Contoh : 8.50" value="8" oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"/>
                    </div>
                    <div class="form-group">
                        <label for="tenor">Jangka Waktu (dalam tahun)</label>
                        <input type="text" name="tenor" id="tenor" class="form-control input-sm" value="15" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="penghasilan" min="5000000" id="penghasilan" class="form-control input-sm" required="required" placeholder="Contoh : 5000000" value="5000000"/>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success btn-md col-xs-12">HITUNG CICILAN</button>
                </form>
            </div>
            <div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                <h3>Perhitungan</h3>
...
function uangMuka() {
    var x = document.getElementById("uang_muka");
    x.value = parseInt(document.getElementById('harga_rumah').value*0.2);;
}
...
function process(e)
{
    ...
    if (penghasilan<=10000000 && harga_rumah>=500000000 ){
        
        alert('Harga rumah yang anda beli harus dibawah 500 juta');
        return;
    }

    // cicilan_lain >= penghasilan
    if (cicilan_lain > (penghasilan*0.8))
    {   
        alert('Cicilan Lain lebih dari 8 persen Penghasilan per Bulan');
        return ;
    }
